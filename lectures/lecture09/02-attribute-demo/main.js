...
const showCat = (ev) => {
    ...
    document.querySelector('#btn1').src ='https://www.humanesociety.org/sites/default/files/styles/1240x698/public/2018/06/cat-217679.jpg?h=c4ed616d&itok=3qHaqQ56'
};
